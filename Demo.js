...
const ENV = 'demo'; // enviornments available: demo, dev
const VU_COUNT = 100;
const TEST_ID = `${VU_COUNT}vus_test`; // Add test identifier
...
function addRequestCount(counter, count = 1) {
    counter.add(count, { test_id: TEST_ID });
...
const TREATMENT_OPTIONS = [
    {
        ...
        id: 7,
        uuid: '785cb978-0677-4a92-afb6-e3b81517d6a7'
    },
    {
        url: 'https://demo.chairsyde.com/content/?treatment-category=3&treatment=1',
        id: 1,
        uuid: 'd9a9ee5e-4c7b-4871-8d0e-690b31b134de'
    },
    {
        url: 'https://demo.chairsyde.com/content/?treatment-category=4&treatment=15',
        id: 15,
        uuid: '4bf5295e-eaf4-4f36-96fc-f068017296f0'
    },
    {
        url: 'https://demo.chairsyde.com/content/?treatment-category=7&treatment=59',
        id: 59,
        uuid: '6876e64e-37b8-4af6-9234-643414246c09'
    }
];
    ...
    group('Page Load Tests', function () {
        ...
        group('Login Page Load', function () {
            ...
            try {
                ...
                metrics.trends.loginPageLoadTime.add(htmlLoadTime, { test_id: TEST_ID });
                // Count HTML request per VU
                metrics.counters.loginPageTotalRequests.add(1, { test_id: TEST_ID });
                ...
                if (loginSuccess) {
                    ...
                    metrics.counters.loginPageResourceRequests.add(uniqueResourceCount, { test_id: TEST_ID });
                    metrics.counters.loginPageTotalRequests.add(uniqueResourceCount, { test_id: TEST_ID });

                    // Calculate actual parallel load time
                    const resourceLoadTime = new Date() - resourceStartTime;
                    metrics.trends.loginPageResourceTotalTime.add(resourceLoadTime, { test_id: TEST_ID });
                    ...
                    if (resourceRequests.length > 0) {
                        metrics.rates.loginPageResourceFailRate.add(resourceStats.failCount / resourceRequests.length, { test_id: TEST_ID });
                    }

                    // Add average resource time
                    if (resourceStats.successCount > 0) {
                        metrics.trends.loginPageResourceAvgTime.add(resourceStats.totalDuration / resourceStats.successCount, { test_id: TEST_ID });
                    }
            ...
            metrics.rates.loginPageLoadFailRate.add(!loginSuccess, { test_id: TEST_ID });
        });
        ...
        group('Landing Page Load', function () {
            ...
            try {
                ...
                metrics.trends.landingPageLoadTime.add(htmlLoadTime, { test_id: TEST_ID });

                // Count HTML request (only once)
                metrics.counters.landingPageTotalRequests.add(1, { test_id: TEST_ID });
                ...
                if (landingSuccess) {
                    ...
                    metrics.counters.landingPageResourceRequests.add(uniqueResourceCount, { test_id: TEST_ID });
                    metrics.counters.landingPageTotalRequests.add(uniqueResourceCount, { test_id: TEST_ID });

                    // Calculate actual parallel load time
                    const resourceLoadTime = new Date() - resourceStartTime;
                    metrics.trends.landingPageResourceTotalTime.add(resourceLoadTime, { test_id: TEST_ID });
                    ...
                    // Add resource failure rate
                    if (resourceRequests.length > 0) {
                        metrics.rates.landingPageResourceFailRate.add(resourceStats.failCount / resourceRequests.length, { test_id: TEST_ID });
                    }

                    // Add average resource time
                    if (resourceStats.successCount > 0) {
                        metrics.trends.landingPageResourceAvgTime.add(resourceStats.totalDuration / resourceStats.successCount, { test_id: TEST_ID });
                    }
            ...
            metrics.rates.landingPageLoadFailRate.add(!landingSuccess, { test_id: TEST_ID });
        });
        ...
        group('Login flow', function () {
            ...
            group('CSRF', function () {
                ...
                try {
                    ...
                    metrics.counters.csrfRequests.add(1, { test_id: TEST_ID });
                ...
                metrics.rates.csrfFailRate.add(!csrfSuccess, { test_id: TEST_ID });
                metrics.trends.csrfTime.add(new Date() - csrfStartTime, { test_id: TEST_ID });
            });
            ...
            group('Login', function () {
                ...
                try {
                    ...
                    metrics.counters.loginRequests.add(1, { test_id: TEST_ID });
                ...
                metrics.rates.loginFailRate.add(!loginSuccess, { test_id: TEST_ID });
                metrics.trends.loginTime.add(new Date() - loginStartTime, { test_id: TEST_ID });
            });
            ...
            group('Get User', function () {
                ...
                try {
                    ...
                    metrics.counters.getUserRequests.add(1, { test_id: TEST_ID });
                ...
                metrics.rates.getUserFailRate.add(!userSuccess, { test_id: TEST_ID });
                metrics.trends.getUserTime.add(new Date() - getUserStartTime, { test_id: TEST_ID });
            });
            ...
            group('Broadcasting Auth', function () {
                ...
                try {
                    ...
                    metrics.counters.broadcastAuthRequests.add(1, { test_id: TEST_ID });
                ...
                metrics.rates.broadcastAuthFailRate.add(!broadcastSuccess, { test_id: TEST_ID });
                metrics.trends.broadcastAuthTime.add(new Date() - broadcastStartTime, { test_id: TEST_ID });
            });
            ...
            group('Education Content', function () {
                ...
                try {
                    ...
                    metrics.counters.educationConditionsRequests.add(1, { test_id: TEST_ID });
                    ...
                    metrics.rates.educationConditionsFailRate.add(!conditionsSuccess, { test_id: TEST_ID });
                    metrics.trends.educationConditionsTime.add(new Date() - conditionsStartTime, { test_id: TEST_ID });
                    // Get treatment categories
                    const treatmentStartTime = new Date();
                    metrics.counters.educationTreatmentRequests.add(1, { test_id: TEST_ID });
                    ...
                    metrics.rates.educationTreatmentFailRate.add(!treatmentSuccess, { test_id: TEST_ID });
                    metrics.trends.educationTreatmentTime.add(new Date() - treatmentStartTime, { test_id: TEST_ID });
                    // Get risk categories
                    const riskStartTime = new Date();
                    metrics.counters.educationRiskRequests.add(1, { test_id: TEST_ID });
                    ...
                    metrics.rates.educationRiskFailRate.add(!riskSuccess, { test_id: TEST_ID });
                    metrics.trends.educationRiskTime.add(new Date() - riskStartTime, { test_id: TEST_ID });
                    // Get playlist
                    const playlistStartTime = new Date();
                    metrics.counters.educationPlaylistRequests.add(1, { test_id: TEST_ID });
                    ...
                    metrics.rates.educationPlaylistFailRate.add(!playlistSuccess, { test_id: TEST_ID });
                    metrics.trends.educationPlaylistTime.add(new Date() - playlistStartTime, { test_id: TEST_ID });
                } catch (err) {
        ...
        group('Voice Note Page Load', function () {
            ...
            try {
                ...
                metrics.trends.voiceNotePageLoadTime.add(htmlLoadTime, { test_id: TEST_ID });

                // Count HTML request per VU
                metrics.counters.voiceNotePageTotalRequests.add(1, { test_id: TEST_ID });
                ...
                if (voiceNoteSuccess) {
                    ...
                    metrics.counters.voiceNotePageResourceRequests.add(uniqueResourceCount, { test_id: TEST_ID });
                    metrics.counters.voiceNotePageTotalRequests.add(uniqueResourceCount, { test_id: TEST_ID });

                    // Calculate actual parallel load time
                    const resourceLoadTime = new Date() - resourceStartTime;
                    metrics.trends.voiceNotePageResourceTotalTime.add(resourceLoadTime, { test_id: TEST_ID });
                    ...
                    // Add resource failure rate
                    if (resourceRequests.length > 0) {
                        metrics.rates.voiceNotePageResourceFailRate.add(resourceStats.failCount / resourceRequests.length, { test_id: TEST_ID });
                    }

                    // Add average resource time
                    if (resourceStats.successCount > 0) {
                        metrics.trends.voiceNotePageResourceAvgTime.add(resourceStats.totalDuration / resourceStats.successCount, { test_id: TEST_ID });
                    }
        ...
        group('Patient Session', function () {
            ...
            group('Create Patient Session', function () {
                ...
                try {
                    ...
                    metrics.counters.createSessionRequests.add(1, { test_id: TEST_ID });
                        ...
                        group('Upload Voice Note', function () {
                            ...
                            group('upload voice note chunks to S3', function () {
                                ...
                                for (let i = 0; i < chunkFiles.length; i++) {
                                    ...
                                    metrics.counters.s3UploadRequests.add(1, { test_id: TEST_ID });
                                            ...
                                            try {
                                                ...
                                                if (landingSuccess && sessionId) {
                                                    ...
                                                    group('Video Playback During Upload', function() {
                                                        ...
                                                        metrics.counters.videoPlaybackPageRequests.add(1, { test_id: TEST_ID });
                                                        ...
                                                        metrics.trends.videoPlaybackPageLoadTime.add(midUploadVideoPageLoadTime, { test_id: TEST_ID });
                                                        ...
                                                        metrics.rates.videoPlaybackPageFailRate.add(!midUploadVideoPageSuccess, { test_id: TEST_ID });

                                                        // First API call - education-content-view-tracking
                                                        metrics.counters.contentViewTrackingRequests.add(1, { test_id: TEST_ID });
                                                        metrics.counters.educationContentViewTrackingRequests.add(1, { test_id: TEST_ID });
                                                        ...
                                                        metrics.trends.educationContentViewTrackingTime.add(viewTrackingTime, { test_id: TEST_ID });
                                                        const viewTrackingSuccess = check(contentTrackingRes, {
                                                            'Education content view tracking successful': (r) => r.status === 200 || r.status === 201,
                                                        });
                                                        metrics.rates.educationContentViewTrackingFailRate.add(!viewTrackingSuccess, { test_id: TEST_ID });
                                                        ...
                                                        metrics.counters.educationTrackingCreateRequests.add(1, { test_id: TEST_ID });
                                ...
                                if (uploadData && uploadData.segment_key && successCount > 0) {
                                    ...
                                    group('Stop', function () {
                                        ...
                                        try {
                                            ...
                                            metrics.counters.stop1Requests.add(1, { test_id: TEST_ID });
                                        ...
                                        try {
                                            ...
                                            metrics.counters.transcribeRequests.add(1, { test_id: TEST_ID });
                                        ...
                                        try {
                                            ...
                                            metrics.counters.createTitleRequests.add(1, { test_id: TEST_ID });
                ...
                metrics.rates.createSessionFailRate.add(!createSessionSuccess, { test_id: TEST_ID });
            });
        });
    });
}
